...
writeFileSync('./util/tracker-events.json', JSON.stringify(
    [...newReplay.getTrackerEvents()],
    (key, value) => typeof value === 'bigint' ? value.toString() : value,
    2
));

writeFileSync('./util/game-events.json', JSON.stringify(
    [...newReplay.getGameEvents()],
    (key, value) => typeof value === 'bigint' ? value.toString() : value,
    2
));

writeFileSync('./util/message-events.json', JSON.stringify(
